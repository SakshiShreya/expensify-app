...
const expenseOne = store.dispatch(addExpense({ description: 'Rent', createdAt: 130, amount: 8000 }));
const expenseTwo = store.dispatch(addExpense({ description: 'Pasta', createdAt: 129, amount: 80 }));
...
const demoState = {
  expenses: [
    {
      id: 'qwwej',
      description: 'jsaghojsad zjkch',
      note: 'asdjk dshgf dslhdsui asldddiud dfi dsfiew dsds sdi',
      amount: 13134,
      createdAt: 0
    }
  ],
